...
class Solution:
    def pivotIndex(self, nums: List[int]) -> int:
        total = sum(nums) # we can find the total of the list to make it easier to compare halves 
        print(total)
        leftSum = 0 # initialize count of left side of list
        ...
        return -1 # if no pivot index return -1
